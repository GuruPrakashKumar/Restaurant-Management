      ...
      switch (key) {
        case 1:
          ...
          do {
            ...
            System.out.println(
              "Do you want to book more table: (1.Yes or 2.No"
            );
            int h = sc.nextInt();
            if (h == 1) {
              count++;
        ...
        case 4:
          ...
          for (int j = 0; j < count; j++) {
            if (k == ob[j].id) {
              ...
              System.out.println("Phone\t:" + ob[j].getPhone());
        ...
        case 7:
          ...
          for (int j = 0; j < count; j++) {
            if (ob[j].sum > max) {
              ...
              System.out.println(
                ob[j].name + "Spend " + ob[j].sum + " Thanks for choosing us"
              );
              System.out.println(
                "---------------------------------------------------"
              );
...
class Rms {
  ...
  void showMenu() {
    ...
    System.out.println(
      "\t\t1.idly      \tRs.30        \t\t6.uttapam   \tRs.30"
    );
    System.out.println(
      "\t\t2.wada      \tRs.35        \t\t7.bonda     \tRs.25"
    );
    System.out.println(
      "\t\t3.dosa      \tRs.40        \t\t8.tea       \tRs.10"
    );
    System.out.println(
      "\t\t4.poori     \tRs.30        \t\t9.coffee    \tRs.15"
    );
